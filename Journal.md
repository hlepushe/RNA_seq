...
После различных переделок в итоге файл выравнивания alignment_pendula.sh. После выравнивания (идет чуть более суток) файлы пикарда для чтения групп, сортировки и индексирования. bam + bam.bai выгружаем и смотрим в IGV. В целевом участке не оказалось ридов.  
...
Новое окружение 'new-salmon' для более новой версии 1.10.2. 
